...
if __name__ == '__main__':
    crop_size = 224
    regen_frozen_graph('/home/tamvm/Projects/tensorflow-models/research/object_detection/wider_face_models/ssd224',
                        pipeline='ssd_mobilenet_v2_quantized_224x224_widerface.config',
                        ckpt='model.ckpt-403424')
